...
export class PlayComponent implements OnInit, AfterContentInit, AfterViewChecked, OnDestroy {
  ...
  clickConnect() {
    ...
    this.sendLogLine('WARN', 'Please note that IPs and user agents are hashed only to prevent abuse.');
    this.sendLogLine('WARN', 'All the tracking information will be deleted once user leaves browser.');
